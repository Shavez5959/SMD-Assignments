...
public class SnacksFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        snackAdapter.setOnQuantityChangeListener(()-> updateTotalPrice());
    ...
    private void init(View view){
        ...
        snacks.add(new Snack(R.drawable.popcorn, "Popcorn" , "Large / Buttered", 8.99 , 0));
        snacks.add(new Snack(R.drawable.nachos, "Nachos" , "With Cheese Dip", 7.99 , 0));
        snacks.add(new Snack(R.drawable.drink, "Soft Drink" , "Large / Any Flavor", 5.99 , 0));
        snacks.add(new Snack(R.drawable.candy, "Candy Mix" , "Assorted Candies", 6.99 , 0));
